...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_A,           MT(MOD_LSFT, KC_S),MT(MOD_LALT, KC_D),MT(MOD_LCTL, KC_F),KC_G,                                           KC_H,           MT(MOD_RCTL, KC_J),MT(MOD_RALT, KC_K),MT(MOD_RSFT, KC_L),KC_SCLN,        KC_TRANSPARENT, 
    KC_LEFT_GUI,    KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         LT(3,KC_SLASH), TG(1),          
                                                    MT(MOD_RGUI, KC_ENTER),MT(MOD_LSFT, KC_TAB),                                LT(1,KC_BSPC),  LT(2,KC_SPACE)
  ),
  [1] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_F1,          KC_F2,          KC_F3,          KC_F4,          KC_F5,                                          KC_F6,          KC_F7,          KC_F8,          KC_F9,          KC_F10,         KC_F11,         
    KC_TRANSPARENT, KC_NO,          KC_MS_BTN1,     KC_MS_UP,       KC_MS_BTN2,     KC_NO,                                          KC_PAGE_UP,     KC_HOME,        LGUI(KC_TAB),   LGUI(KC_GRAVE), KC_PLUS,        KC_PIPE,        
  ...
  [2] = LAYOUT_voyager(
    ...
    KC_NO,          KC_GRAVE,       KC_MINUS,       KC_EQUAL,       KC_COMMA,       KC_DOT,                                         KC_0,           KC_1,           KC_2,           KC_3,           KC_EQUAL,       KC_TRANSPARENT, 
    KC_NO,          KC_SCLN,        KC_QUOTE,       KC_BSLS,        KC_LPRN,        KC_RPRN,                                        KC_COMMA,       KC_4,           KC_5,           KC_6,           KC_SCLN,        KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, RCTL(KC_A),     KC_LBRC,        KC_RBRC,                                        KC_DOT,         KC_7,           KC_8,           KC_9,           KC_SLASH,       KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [3] = LAYOUT_voyager(
...
const uint16_t PROGMEM combo0[] = { KC_U, KC_I, KC_O, COMBO_END};
const uint16_t PROGMEM combo1[] = { KC_R, KC_E, KC_W, COMBO_END};
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    ...
    [1] = { {0,0,255}, {52,160,206}, {52,160,206}, {52,160,206}, {52,160,206}, {52,160,206}, {0,0,255}, {3,255,255}, {3,255,255}, {3,255,255}, {3,255,255}, {0,245,245}, {0,0,255}, {0,245,245}, {3,255,255}, {3,255,255}, {3,255,255}, {0,245,245}, {0,0,255}, {0,245,245}, {0,245,245}, {3,255,255}, {0,245,245}, {0,245,245}, {0,245,245}, {0,245,245}, {52,160,206}, {52,160,206}, {52,160,206}, {52,160,206}, {52,160,206}, {52,160,206}, {0,245,245}, {0,245,245}, {0,245,245}, {0,245,245}, {0,0,255}, {0,0,255}, {41,249,240}, {41,249,240}, {41,249,240}, {41,249,240}, {0,0,255}, {0,0,255}, {0,245,245}, {0,245,245}, {0,245,245}, {0,245,245}, {0,245,245}, {96,255,255}, {0,245,245}, {0,245,245} },
    ...
    [3] = { {41,249,240}, {41,249,240}, {41,249,240}, {41,249,240}, {41,249,240}, {41,249,240}, {41,249,240}, {163,222,119}, {163,222,119}, {52,160,206}, {52,160,206}, {52,160,206}, {41,249,240}, {41,249,240}, {52,160,206}, {52,160,206}, {52,160,206}, {52,160,206}, {41,249,240}, {41,249,240}, {41,249,240}, {41,249,240}, {41,249,240}, {52,160,206}, {41,249,240}, {41,249,240}, {41,249,240}, {41,249,240}, {41,249,240}, {41,249,240}, {41,249,240}, {41,249,240}, {41,249,240}, {41,249,240}, {41,249,240}, {41,249,240}, {41,249,240}, {41,249,240}, {41,249,240}, {41,249,240}, {41,249,240}, {41,249,240}, {41,249,240}, {41,249,240}, {41,249,240}, {41,249,240}, {41,249,240}, {41,249,240}, {52,160,206}, {41,249,240}, {41,249,240}, {41,249,240} },
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  switch (keycode) {
    ...
    case ST_MACRO_8:
    if (record->event.pressed) {
      SEND_STRING(SS_RCTL(SS_TAP(X_A)) SS_DELAY(100) SS_LSFT(SS_TAP(X_BSLS)));
    }
    break;
    case ST_MACRO_9:
    if (record->event.pressed) {
