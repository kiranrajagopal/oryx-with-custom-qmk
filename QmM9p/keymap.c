...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_LEFT_CTRL,   KC_A,           MT(MOD_LSFT, KC_S),MT(MOD_LALT, KC_D),MT(MOD_LCTL, KC_F),KC_G,                                           KC_H,           MT(MOD_RCTL, KC_A),MT(MOD_RALT, KC_K),MT(MOD_RSFT, KC_L),LT(3,KC_SCLN),  KC_RIGHT_CTRL,  
